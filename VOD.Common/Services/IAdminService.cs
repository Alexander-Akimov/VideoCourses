...
namespace VOD.Common.Services
{
    ...
    {
        Task<List<TDestination>> GetAsync<TSourse, TDestination>(params Expression<Func<TSourse, object>>[] include)
            where TSourse : class where TDestination : class;
        Task<List<TDestination>> GetAsync<TSourse, TDestination>(Expression<Func<TSourse, bool>> whereExpr,
        ...
        Task<TDestination> SingleAsync<TSourse, TDestination>(Expression<Func<TSourse, bool>> whereExpr, bool include = false) where TSourse : class where TDestination : class;
        Task<TDestination> SingleAsync<TSourse, TDestination>(Expression<Func<TSourse, bool>> whereExpr,
           params Expression<Func<TSourse, object>>[] include) where TSourse : class where TDestination : class;
