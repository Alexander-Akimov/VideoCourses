...
namespace VOD.Database
{
    public class DbInitializer
    {
        public static void Initialize(VODContext context)
        {
            ...
            if (!userId.Equals(string.Empty))
            {
                ...
                if (!context.Courses.Any())
                {
                    ...
                    instructorId2 = instructor?.Id ?? instructorId1;
                ...
                if (context.Courses.Any())
                {
                    ...
                    courseId2 = course?.Id ?? courseId2;

                    course = context.Courses.Skip(2).FirstOrDefault();
                    courseId3 = course?.Id ?? courseId3;
                }
                ...
                if (!context.Modules.Any())
                {
                    ...
                    {
                        new Module { Course = context.Find<Course>(courseId1),Title = "Module 1" },
                        new Module { Course = context.Find<Course>(courseId1),Title = "Module 2" },
                        new Module { Course = context.Find<Course>(courseId2),Title = "Module 3" }
                    };
                ...
                if (context.Modules.Any())
                {
                    ...
                    moduleId2 = module?.Id ?? moduleId1;

                    module = context.Modules.Skip(2).FirstOrDefault();
                    moduleId3 = module?.Id ?? moduleId1;
                }
        ...
        public static void RecreateDatabase(DbContext context)
        {
            //this deletes all data in the entire database.
